...
public class LuaFramework_LuaComponentWrap
{
	...
	{
		L.BeginClass(typeof(LuaFramework.LuaComponent), typeof(View));
	...
	static int Add(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				...
				LuaInterface.LuaTable o = LuaFramework.LuaComponent.Add(arg0, arg1);
				ToLua.Push(L, o);
				return 1;
			}
			else if (count == 3 && TypeChecker.CheckTypes<LuaInterface.LuaTable>(L, 3))
			{
				...
				LuaInterface.LuaTable o = LuaFramework.LuaComponent.Add(arg0, arg1, arg2);
				ToLua.Push(L, o);
				return 1;
			}
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaFramework.LuaComponent.Add");
			}
		}
		catch (Exception e)
		{
	...
	static int Get(IntPtr L)
	{
		try
		{
			...
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckObject(L, 1, typeof(UnityEngine.GameObject));
			LuaTable arg1 = ToLua.CheckLuaTable(L, 2);
			LuaInterface.LuaTable o = LuaFramework.LuaComponent.Get(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
